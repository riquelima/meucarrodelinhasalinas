...
import { FileText, Shield, Share2, MessageSquare, Instagram } from "lucide-react";
...
export function Footer({ onNavigate }: { onNavigate?: (path: string) => void }) {
  ...
  return (
    <footer className="bg-card border-t border-border pt-10 pb-6 mt-8 text-sm">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 gap-8 mb-6 max-w-md mx-auto">
                ...
                return (
                  <li key={link.label}>
                    <button
                      ...
                      className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors w-full justify-center text-sm"
                    >
          ...
          {/* Community */}
          <div>
            <h4 className="text-foreground mb-2 font-semibold text-center text-sm uppercase tracking-wide">Comunidade</h4>
            <ul className="space-y-2">
